...
# Configure cache directories on D drive when running locally (not in Hugging Face Spaces cloud).
...
if not os.environ.get("SPACE_ID"):
    ...
    # Since all models are downloaded locally to D drive when running locally, enable offline mode.
